...
public:
    ...
    *
    * Macros: MPU6050_BW_256 - MPU6050_BW_188 - MPU6050_BW_98 - MPU6050_BW_42 -
    * MPU6050_BW_20 - MPU6050_BW_10 - MPU6050_BW_5
    * Last number is the gyro's BW in Hz (accelero BW is virtually identical)
    *
    * @param BW - The three bits that set the bandwidth (use the predefined
    * macros)
    */
    void setBW(uint8_t BW);

    /**
    * Sets the auxiliary I2C bus in bypass mode to read the sensors behind the
    * MPU6050 (useful for eval board, otherwise just connect them to primary I2C
    * bus)
    *
    ...
    *
    * Macros: MPU6050_ACCELERO_RANGE_2G - MPU6050_ACCELERO_RANGE_4G -
    * MPU6050_ACCELERO_RANGE_8G - MPU6050_ACCELERO_RANGE_16G
    *
    * @param range - The two bits that set the full-scale range (use the
    * predefined macros)
    */
    ...
    *
    * @param data - pointer to signed integer array with length three: data[0] =
    * X, data[1] = Y, data[2] = Z
    */
    ...
    *
    * Function uses the last setup value of the full scale range, if you
    * manually set in another range, this won't work.
    *
    * @param data - pointer to float array with length three: data[0] = X,
    * data[1] = Y, data[2] = Z
    */
    ...
    *
    * Macros: MPU6050_GYRO_RANGE_250 - MPU6050_GYRO_RANGE_500 -
    ...
    */
    ...
    /**
    * Writes data to the device, could be private, but public is handy so you
    * can transmit directly to the MPU.
    *
    ...
    */
    ...
    /**
    * Read data from the device, could be private, but public is handy so you
    * can transmit directly to the MPU.
    *
    * @param adress - register address to write to
    ...
    */
    ...
    /**
    * Read multtiple regigsters from the device, more efficient than using
    * multiple normal reads.
    *
    * @param adress - register address to write to
