 ...
 *          This file supports assembler and C development for DW1000 enabled
 * devices
 *
 * @attention
 *
 ...
 **/
#define DEV_ID_ID \
    0x00 /* Device ID register, includes revision info (0xDECA0130) */
#define DEV_ID_LEN (4)
/* mask and shift */
...
#define SYS_CFG_FFAD \
    0x00000008UL /* Frame Filtering Allow Data frame reception */
#define SYS_CFG_FFAA \
    0x00000010UL /* Frame Filtering Allow Acknowledgment frame reception */
#define SYS_CFG_FFAM \
...
#define SYS_CFG_AACKPEND \
    0x80000000UL /* Automatic Acknowledgement Pending bit control */
...
/*masks (low 32 bit) */
#define TX_FCTRL_TFLEN_MASK \
    0x0000007FUL /* bit mask to access Transmit Frame Length */
#define TX_FCTRL_TFLE_MASK \
    0x00000380UL /* bit mask to access Transmit Frame Length Extension */
#define TX_FCTRL_FLE_MASK \
    0x000003FFUL /* bit mask to access Frame Length field */
#define TX_FCTRL_TXBR_MASK \
...
/*offset 16 */
#define TX_FCTRL_TXPRF_SHFT \
    (16) /* shift to access Pulse Repetition Frequency field */
#define TX_FCTRL_TXPRF_4M \
    0x00000000UL /* Transmit Pulse Repetition Frequency = 4 Mhz */
#define TX_FCTRL_TXPRF_16M \
    0x00010000UL /* Transmit Pulse Repetition Frequency = 16 Mhz */
#define TX_FCTRL_TXPRF_64M \
...
#define TX_FCTRL_TXPSR_PE_64 \
    0x00040000UL /* bit mask to access Preamble Extension = 64 */
#define TX_FCTRL_TXPSR_PE_128 \
    0x00140000UL /* bit mask to access Preamble Extension = 128 */
#define TX_FCTRL_TXPSR_PE_256 \
    0x00240000UL /* bit mask to access Preamble Extension = 256 */
#define TX_FCTRL_TXPSR_PE_512 \
    0x00340000UL /* bit mask to access Preamble Extension = 512 */
#define TX_FCTRL_TXPSR_PE_1024 \
    0x00080000UL /* bit mask to access Preamble Extension = 1024 */
#define TX_FCTRL_TXPSR_PE_1536 \
    0x00180000UL /* bit mask to access Preamble Extension = 1536 */
#define TX_FCTRL_TXPSR_PE_2048 \
    0x00280000UL /* bit mask to access Preamble Extension = 2048 */
#define TX_FCTRL_TXPSR_PE_4096 \
    0x000C0000UL /* bit mask to access Preamble Extension = 4096 */
/*offset 22 */
...
#define TX_FCTRL_IFSDELAY_MASK \
    0xFF00000000ULL /* bit mask to access Inter-Frame Spacing field */
...
#define SYS_MASK_MAAT \
    0x00000008UL /* Mask automatic acknowledge trigger event */
...
/*offset 8 */
#define SYS_MASK_MRXPRD \
    0x00000100UL /* Mask receiver preamble detected event    */
...
/*offset 16 */
#define SYS_MASK_MRXRFSL \
    0x00010000UL /* Mask receiver Reed Solomon Frame Sync Loss event */
#define SYS_MASK_MRXRFTO \
    0x00020000UL /* Mask Receive Frame Wait Timeout event    */
#define SYS_MASK_MLDEERR \
    0x00040000UL /* Mask leading edge detection processing error event   */
#define SYS_MASK_MRXOVRR 0x00100000UL /* Mask Receiver Overrun event  */
#define SYS_MASK_MRXPTO \
    0x00200000UL /* Mask Preamble detection timeout event    */
...
/*offset 24*/
#define SYS_MASK_MRFPLLLL \
    0x01000000UL /* Mask RF PLL Loosing Lock warning event   */
#define SYS_MASK_MCPLLLL \
    0x02000000UL /* Mask Clock PLL Loosing Lock warning event    */
#define SYS_MASK_MRXSFDTO 0x04000000UL /* Mask Receive SFD timeout event   */
#define SYS_MASK_MHPDWARN \
    0x08000000UL                      /* Mask Half Period Delay Warning event */
#define SYS_MASK_MTXBERR 0x10000000UL /* Mask Transmit Buffer Error event */
#define SYS_MASK_MAFFREJ \
    0x20000000UL /* Mask Automatic Frame Filtering rejection event   */
...
#define SYS_STATUS_RXSFDD \
    0x00000200UL /* Receiver Start Frame Delimiter Detected. */
...
/*offset 32 */
#define SYS_STATUS_RXRSCS \
    0x0100000000ULL /* Receiver Reed-Solomon Correction Status */
...
#define SYS_STATUS_ALL_RX_GOOD                                \
    (SYS_STATUS_RXDFR | SYS_STATUS_RXFCG | SYS_STATUS_RXPRD | \
...
#define SYS_STATUS_ALL_TX                                                      \
    (SYS_STATUS_AAT | SYS_STATUS_TXFRB | SYS_STATUS_TXPRS | SYS_STATUS_TXPHS | \
     SYS_STATUS_TXFRS)
...
#define RX_FINFO_RXFL_MASK_1023 \
    0x000003FFUL /* Receive Frame Length Extension (0 to 1023) */

#define RX_FINFO_RXNSPL_MASK \
...
#define RX_FINFO_RXPEL_MASK \
    0x000C1800UL /* Receive Preamble Length = RXPSR+RXNSPL */
...
#define RX_FINFO_RXPRF_16M \
    0x00010000UL /* PRF being employed in the receiver = 16M */
#define RX_FINFO_RXPRF_64M \
    0x00020000UL /* PRF being employed in the receiver = 64M */
 ...
 **/
#define RX_FQUAL_ID \
    0x12 /* Rx Frame Quality information (in double buffer set) */
...
/*offset 32*/
#define RX_EQUAL_PP_AMPL3_MASK \
    0x0000FFFF00000000ULL /* First Path Amplitude point 3 */
...
/*offset 48*/
#define RX_EQUAL_CIR_MXG_MASK \
    0xFFFF000000000000ULL /* Channel Impulse Response Max Growth */
...
/****************************************************************************/ /**
  ...
  *      The value in RXTTCKI will take just one of two values depending on the
  *PRF: 0x01F00000 @ 16 MHz PRF,
  *      and 0x01FC0000 @ 64 MHz PRF.
 **/
#define RX_TTCKI_ID \
    0x13 /* Receiver Time Tracking Interval (in double buffer set) */
 ...
 **/
#define RX_TIME_ID \
    0x15 /* Receive Message Time of Arrival (in double buffer set) */
#define RX_TIME_LLEN (14)
#define RX_TIME_RX_STAMP_LEN \
    (5) /* read only 5 bytes (the adjusted timestamp (40:0)) */
#define RX_STAMP_LEN RX_TIME_RX_STAMP_LEN
/*mask and shift */
#define RX_TIME_RX_STAMP_OFFSET \
    (0) /* byte 0..4 40 bit Reports the fully adjusted time of reception. */
#define RX_TIME_FP_INDEX_OFFSET (5) /* byte 5..6 16 bit First path index. */
#define RX_TIME_FP_AMPL1_OFFSET \
    (7) /* byte 7..8 16 bit First Path Amplitude point 1 */ /* doc bug */
#define RX_TIME_FP_RAWST_OFFSET \
    (9) /* byte 9..13 40 bit Raw Timestamp for the frame */
...
/*mask and shift */
#define TX_TIME_TX_STAMP_OFFSET \
    (0) /* byte 0..4 40 bit Reports the fully adjusted time of transmission */
#define TX_TIME_TX_RAWST_OFFSET \
    (5) /* byte 5..9 40 bit Raw Timestamp for the frame */
...
/*mask and shift */
#define ACK_RESP_T_MASK \
    0xFF0FFFFFUL /* Acknowledgement Time and Response access mask */
#define ACK_RESP_T_W4R_TIM_OFFSET 0 /* In bytes */
#define ACK_RESP_T_W4R_TIM_MASK \
    0x000FFFFFUL /* Wait-for-Response turn-around Time 20 bit field */
#define W4R_TIM_MASK ACK_RESP_T_W4R_TIM_MASK
#define ACK_RESP_T_ACK_TIM_OFFSET 3 /* In bytes */
#define ACK_RESP_T_ACK_TIM_MASK \
    0xFF000000UL /* Auto-Acknowledgement turn-around Time */
...
#define CHAN_CTRL_TX_CHAN_MASK \
    0x0000000FUL /* Supported channels are 1, 2, 3, 4, 5, and 7.*/
#define CHAN_CTRL_TX_CHAN_SHIFT \
    (0) /* Bits 0..3        TX channel number 0-15 selection */

#define CHAN_CTRL_RX_CHAN_MASK 0x000000F0UL
#define CHAN_CTRL_RX_CHAN_SHIFT \
    (4) /* Bits 4..7        RX channel number 0-15 selection */
...
/****************************************************************************/ /**
  ...
  * Please take care to write to this register as doing so may cause the DW1000
  *to malfunction
 **/
...
#define AGC_CTRL1_MASK \
    0x0001 /* access mask to AGC configuration and control register */
#define AGC_CTRL1_DIS_AM \
    0x0001 /* Disable AGC Measurement. The DIS_AM bit is set by default. */
/* offset from AGC_CTRL_ID in bytes */
...
#define GPIO_MODE_OFFSET \
    0x00 /* sub-register 0x00 is the GPIO Mode Control Register */
...
#define GPIO_PIN6_EXTRXE \
    0x00040000UL /* The pin operates as the EXTRXE output */

/* offset from GPIO_CTRL in bytes */
#define GPIO_DIR_OFFSET \
    0x08 /* sub-register 0x08 is the GPIO Direction Control Register */
...
/* offset from GPIO_CTRL in bytes */
#define GPIO_DOUT_OFFSET \
    0x0C /* sub-register 0x0C is the GPIO data output register. */
#define GPIO_DOUT_LEN (3)
#define GPIO_DOUT_MASK GPIO_DIR_MASK

/* offset from GPIO_CTRL in bytes */
#define GPIO_IRQE_OFFSET \
    0x10 /* sub-register 0x10 is the GPIO interrupt enable register */
...
#define GIRQE0 \
    GIRQx0 /* GPIO IRQ Enable for GPIO0 input. Value 1 = enable, 0 = disable*/
...
#define GISEN8 \
    GIRQx8 /* Value 0 = High or Rising-Edge, 1 = Low or falling-edge */
...
/* offset from GPIO_CTRL in bytes */
#define GPIO_ICLR_OFFSET \
    0x20 /* sub-register 0x20 is the GPIO interrupt clear register */
...
#define RF_CONF_TXALLEN_MASK                                       \
    (RF_CONF_TXEN_MASK | RF_CONF_TXPOW_MASK | RF_CONF_PLLEN_MASK | \
...
/* offset from TX_CAL_ID in bytes */
#define TC_PGDELAY_OFFSET \
    0x0B /* Transmitter Calibration � Pulse Generator Delay */
...
/* offset from TX_CAL_ID in bytes */
#define TC_PGTEST_OFFSET \
    0x0C /* Transmitter Calibration � Pulse Generator Test */
...
#define AON_ADDR_LPOSC_CAL_0 \
    117 /* Address of low-power oscillator calibration value (lower byte) */
#define AON_ADDR_LPOSC_CAL_1 \
    118 /* Address of low-power oscillator calibration value (lower byte) */

/* offset from AON_ID in bytes */
#define AON_CFG0_OFFSET \
    0x06 /* 32-bit configuration register for the always on block. */
#define AON_CFG0_LEN (4)
#define AON_CFG0_SLEEP_EN \
    0x00000001UL /* This is the sleep enable configuration bit */
...
/****************************************************************************/ /**
  ...
  * Refer to section 7.2.47 Register file: 0x2E � Leading Edge Detection
  *Interface
  * PLEASE NOTE: Other areas within the address space of Register file: 0x2E �
  *Leading Edge Detection Interface
  * are reserved. To ensure proper operation of the LDE algorithm (i.e. to avoid
  *loss of performance or a malfunction),
  * care must be taken not to write to any byte locations other than those
...
/* offset from DIG_DIAG_ID in bytes */
#define EVC_RSE_OFFSET \
    0x06 /* Reed Solomon decoder (Frame Sync Loss) Error Event Counter */
...
/* offset from DIG_DIAG_ID in bytes */
#define EVC_OVR_OFFSET \
    0x0E /* The EVC_OVR field is a 12-bit counter of receive overrun events */
...
/****************************************************************************/ /**
  ...
  * Please take care not to write to these registers as doing so may cause the
...
#define PMSC_CTRL0_SYSCLKS_125M \
...
#define PMSC_CTRL0_PLL2_SEQ_EN \
    0x01000000UL /* Enable PLL2 on/off sequencing by SNIFF mode */
#define PMSC_CTRL0_SOFTRESET_OFFSET 3 /* In bytes */
#define PMSC_CTRL0_RESET_ALL \
    0x00 /* Assuming only 4th byte of the register is read */
#define PMSC_CTRL0_RESET_RX \
    0xE0 /* Assuming only 4th byte of the register is read */
#define PMSC_CTRL0_RESET_CLEAR \
    0xF0 /* Assuming only 4th byte of the register is read */
/* offset from PMSC_ID in bytes */
...
#define PMSC_TXFINESEQ_DISABLE \
    0x0 /* Writing this disables fine grain sequencing in the transmitter */
#define PMSC_TXFINESEQ_ENABLE \
    0x0B74 /* Writing this enables fine grain sequencing in the transmitter */
/* offset from PMSC_ID in bytes */
...
#define PMSC_LEDC_BLINK_TIME_DEF 0x03
